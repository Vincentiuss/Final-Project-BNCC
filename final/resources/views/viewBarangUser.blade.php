        ...
        <div class="card shadow">
            <div class="card-header text-center"> </div>
                <div class="card-body">
                    ...
                    <br>
                        <form action="/get-invoice" method="get" class="input-group row">
                            <button type="submit" class="btn btn-success">See all invoice</button>
                        </form>
                    <br>
                    </div>
                    <table class="table table-bordered">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col">Add items to cart</th>
                            </tr>
                        </thead>
                        <tbody>
                        @foreach ($barangs as $bara)
                            <tr>
                                ...
                                <td>
                                    <a href="/createFaktur">
                                        <button type="submit" class="btn btn-success col-md"><img src="plus-solid.svg" alt="">Add to cart</button>
                                    </a>
                                </td>
                            </tr>
                        @endforeach
