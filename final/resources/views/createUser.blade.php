...
<div class="container col-md-6" style="padding-top: 20px">
        ...
        <div class="card-header text-center"> </div>
            <div class="card-body">
                <form action="create1" method="Post" enctype="multipart/form-data" id="form">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="Email" type="numeric" class="form-control" id="email" placeholder="Input Email" value="{{ old('Email') }}">
